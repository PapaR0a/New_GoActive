...
public class BWPopupMessageView : MonoBehaviour
{
	...
	private string GetContent(BWPopupIconType iconType, string content)
	{
		if(content == "")
		{
			return I18N.instance.getValue(iconType == BWPopupIconType.Success ? BWLangConstant.SUCCESSFUL : BWLangConstant.FAILED);
		}

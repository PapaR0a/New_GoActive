...
public static class NativeGallery
{
	...
	{
		return SaveImageToGallery(mediaBytes, album, filenameFormatted, null);
	}
    public static Permission SaveImageToGallery(byte[] mediaBytes, string album, string filenameFormatted, MediaSaveCallback callback)
    {
	...
	{
		return SaveImageToGallery(existingMediaPath, album, filenameFormatted, null);
	}
    public static Permission SaveImageToGallery(string existingMediaPath, string album, string filenameFormatted, MediaSaveCallback callback)
    {
	...
	{
		return SaveImageToGallery(image, album, filenameFormatted, null);
	}
    public static Permission SaveImageToGallery(Texture2D image, string album, string filenameFormatted, MediaSaveCallback callback)
    {
        if (image == null)
        {
	...
	{
		return SaveVideoToGallery(mediaBytes, album, filenameFormatted,  null);
	}
    public static Permission SaveVideoToGallery(byte[] mediaBytes, string album, string filenameFormatted, MediaSaveCallback callback)
    {
	...
	{
		return SaveVideoToGallery(existingMediaPath, album, filenameFormatted, null);
	}
    public static Permission SaveVideoToGallery(string existingMediaPath, string album, string filenameFormatted, MediaSaveCallback callback)
    {
	...
	public static Permission GetImageFromGallery(MediaPickCallback callback)
	{
		return GetImageFromGallery(callback, "", "image/*", -1);
	}
    public static Permission GetImageFromGallery(MediaPickCallback callback, string title, string mime , int maxSize)
    {
        return GetMediaFromGallery(callback, true, mime, title, maxSize);
    }
	public static Permission GetVideoFromGallery(MediaPickCallback callback)
	{
		return GetVideoFromGallery(callback, "", "video/*");
	}
	public static Permission GetVideoFromGallery(MediaPickCallback callback, string title)
	{
		return GetVideoFromGallery(callback, title, "video/*");
	}
    public static Permission GetVideoFromGallery(MediaPickCallback callback, string title , string mime)
    {
        return GetMediaFromGallery(callback, false, mime, title, -1);
    }
	public static Permission GetImagesFromGallery(MediaPickMultipleCallback callback)
	{
		return GetImagesFromGallery(callback, "", "image/*", -1);
	}
	public static Permission GetImagesFromGallery(MediaPickMultipleCallback callback, string title , string mime )
	{
		return GetMultipleMediaFromGallery(callback, true, mime, title, -1);
	}
    public static Permission GetImagesFromGallery(MediaPickMultipleCallback callback, string title , string mime , int maxSize )
    {
        return GetMultipleMediaFromGallery(callback, true, mime, title, maxSize);
    }
	public static Permission GetVideosFromGallery(MediaPickMultipleCallback callback)
	{
		return GetVideosFromGallery( callback,   "",  "video/*");
	}
    public static Permission GetVideosFromGallery(MediaPickMultipleCallback callback, string title , string mime)
    {
	...
	{
		return LoadImageAtPath(imagePath, -1, true, true, false);
	}
	public static Texture2D LoadImageAtPath(string imagePath, int size)
	{
		return LoadImageAtPath(imagePath, size, true, true, false);
	}
    public static Texture2D LoadImageAtPath(string imagePath, int maxSize , bool markTextureNonReadable , bool generateMipmaps , bool linearColorSpace )
    {
